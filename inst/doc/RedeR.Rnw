...
scriptFile <- system.file("script", "casePart1.R", package="RedeR")
source(scriptFile)
deaPipeline()
deaFigures()
...
graphPipeline4RedeR()
@
p.s.1 source 'casePart1.R' is  available in the package .doc directory.\\
...
\begin{small}
<<label=Pre-processing pipelines, eval=FALSE>>=
scriptFile <- system.file("script", "casePart2.R", package="RedeR")
source(scriptFile)
analysesPipeline()
gscoPipeline4RedeR()
ppiPipeline4RedeR()
@
p.s.1 source 'casePart2.R' is  available in the package .doc directory.\\
