...
setMethod ('addGraph', 'RedPort', 
  function (obj, g, layout=layout.fruchterman.reingold(g), gscale=75, gcoord=c(50,50), isNest=FALSE, nestImage='plain', 
    ...
    nestref=NULL
    if(isNest){
        nestref=nestNodes(obj, nodes, nestImage, isAssign, isAnchor, gscale=NULL, gatt=gatt, theme=theme)
...
setMethod ('nestNodes', 'RedPort', 
  function (obj, nodes, nestImage ='plain', isAssign=TRUE, isAnchor=FALSE, gscale=40, parent=NULL, 
